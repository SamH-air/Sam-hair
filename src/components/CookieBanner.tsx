    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            onClick={decline}
            className="text-lavender-blush/80 text-sm px-2 py-2 hover:text-lavender-blush transition-colors underline underline-offset-2"
          >
            Refuser
          </button>
          <button
          ...
          <button
            ...
            className="text-lavender-blush/80 hover:text-lavender-blush transition-colors ml-1 p-2"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
